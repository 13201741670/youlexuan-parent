...
<body ng-app="youlexuan" ng-controller="goodsController" ng-init="num=1;loadSku()">
					...
					<div id="specification" class="summary-wrap clearfix">
						<#list specificationList as specification >
							<dl>
								...
								<dd><a href="javascript:;" class="{{isSelected('${specification.attributeName}','${item}')}}" ng-click="selectSpecification('${specification.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span>
									</a></dd>
								</#list>
							</dl>
						...
						<div class="fl title">
							<div class="control-group">
								<div class="controls">
									...
									<a href="javascript:void(0)" class="increment plus" ng-click="andNom(1)">+</a>
									<a href="javascript:void(0)" class="increment mins" ng-click="andNom(-1)">-</a>
								</div>
							</div>
						</div>
						<div class="fl">
						...
						<ul class="goods-list unstyled">
							<li>
								<div class="list-wrap">
									...
									<div class="operate">
										<a href="javascript:void(0);" class="sui-btn btn-bordered" ng-click="addCart()">加入购物车</a>
									</div>
								</div>
							</li>
							<li>
